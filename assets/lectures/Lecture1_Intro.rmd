...
- details can be found on [class website](https://cme195.github.io/project)
...
<img src="./Lecture1-figure/r_word_cloud.png", height="500", width="750",
class="center"></img> 
...
<img src="./Lecture2-figure/rstudio-editor.png",  width="1000"></img> 
...
a <- 34.5 
cat("  Now the class of var_x is ", class(a),"\n")

a <- 27L 
cat("   Next the class of var_x becomes ", class(a),"\n") 
``` 
