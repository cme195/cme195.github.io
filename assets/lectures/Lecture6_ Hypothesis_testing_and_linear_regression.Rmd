...
> - e.g. in medical a study, did the treatment group have better 
...
> - Now one of the standard/traditional methods to **test the equality 
...
* column are car attributes: miles per gallon, number of cylinders, displacement, 
transmission etc.
