--- 
title: 'CME/STATS 195'
subtitle: 'Lecture 3: Importing and manipulating data'
date: "October 4, 2018" 
...
<div class="right", style="width: 35%;"> 
 ![](./Lecture3-figure/tidyverse.jpeg)
  <img src="./Lecture1-figure/tidyverse.png", height="500"></img> 
</div>
...
**Subsetting `tibbles` is strickter** than subsetting `data.frames`,
...
<img src="./Lecture3-figure/readr.jpg", height="300"></img> 
...
```{r}
# To drop columns use a minus, "-" 
select(movies, -(star:writer))
```
...
```{r}
sample_n(movies, 8)                    # fixed number of rows, without replacement
