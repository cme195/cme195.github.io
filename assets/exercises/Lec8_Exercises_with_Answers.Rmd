...
ggplot(DF, aes(x, y, color = kmeans)) + 
...
![](../lectures/Lecture8_Unsupervised_Learning_files/mnistExamples.png)

Download the data from the course repository:

```{r}
# load the already subsetted MNIST data.
mnist.url <- paste0("https://raw.githubusercontent.com/cme195/cme195.github.io/",
                    "master/assets/data/EconomistData.csv/mnist_small.csv")
