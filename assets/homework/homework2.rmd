...
$$RMSE = \sqrt{{1 \over n} \sum\limits_{i = 1}^n(\hat y_i - y_i)^2}$$.
...
# Exercise 4: classification [20pt]
...
accurasy on the test set.

# Exercise 5: `ggmap` [20pt]
...
Then, use `geom_map()` to add the path corresponding to the
